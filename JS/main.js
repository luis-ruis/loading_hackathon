...
class RoadSimulator {
  ...
  addRandomCar() {
    const car = new Car(this.carretera,this.posicionInicial,this.posicionFinal,this.contrario);
...
const carretera1 = document.getElementById("carretera1");
carretera1.style.height="800px";
carretera1.style.left="400px";
carretera1.style.width="50px";
const circle = document.getElementById("circle");

const roadSimulator = new RoadSimulator(carretera1, circle,10,0,false);
...
const carretera2 = document.getElementById("carretera2");
        carretera2.style.height = "800px";
        carretera2.style.left = "340px";
        carretera2.style.top = "-820px";
        carretera2.style.width = "50px";

        const circle2 = document.createElement("div");
        circle2.style.width = "20px";
        circle2.style.height = "20px";
        circle2.style.left = "-25px";
